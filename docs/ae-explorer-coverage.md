...
| AE-USER-021                         | AE-USER-021, AE-REG-014                                                             | #136  | each empty table says which kind of empty it is, with the participant denominator    |
| AE-USER-022                         | AE-USER-022, AE-DATA-001                                                            | #136  | an event-free study reports no adverse events recorded instead of a filter error     |
...
| AE-USER-021/022 (empty states)                   | AE-USER-021, AE-USER-022, AE-REG-014                         | #136  | `getPlugins.test.js`        |
...
| AE-FILT-001..004 (shared filter contract)        | AE-FILT-001, AE-FILT-002, AE-FILT-003, AE-FILT-004           | #136  | `../shared/filters.test.js` |

## Source-matrix routing status (77 rows)

- **Covered (66 rows):** AE-USER-001..022 (see modernization notes below for
