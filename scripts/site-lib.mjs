...
// (SH-CFG-004..009). Prose like "(defaults)" or "—" contributes nothing. The
// requirement-ID prefix is structural (<MODULE>-<AREA>-, e.g. SH-, SROT-) so
// every renderer's coverage rows parse with no per-module edits (#27).
